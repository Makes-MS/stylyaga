    ...
    <li><a href="<?php echo $breadcrumb['href']; ?>"><?php echo $breadcrumb['text']; ?></a></li>
        ...
        <?php if ($error_warning) { ?>
            ...
            <?php } ?>
                        ...
                        <div class="txt_zak">
                        <p>Натиснувши на кнопку ОФОРМИТИ, Ви даєте згоду на обробку вказаних персональних даних у відповідності з законом України "Про захист персональних даних" від 01.06.2010 № 2297-VI і підтверджуєте, що ознайомлені з <a href="/privacy" target="_blank">політикою конфіденційності </a>компанії.</p>
                        </div>
